            ...
            children: [
                                  ...
                                  children: seleccionadasProvider
                                    ...
                                    return Chip(
                                      ...
                                      onDeleted: () {
                                        ...
                                        if (seleccionadasProvider.guiasSeleccionadas.isEmpty) {
                                          Navigator.of(context).pop();
                                        }
                                      },
                                    );
              ...
              Padding(
                ...
                child: TextButton(
                  ...
                  onPressed: () async {
                    try {
                      final condicional = context.read<ModalSwitchProvider>().isSwitched ? '1' : '0';
                      final guias = context.read<EnviarListaGuiasProvider>().guiasSeleccionadas;
                      final usuario = context.read<Authprovider>().username;
                      final longitud = context.read<LocationProvider>().currentLocation?.longitude;
                      final latitud = context.read<LocationProvider>().currentLocation?.latitude;
