        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Expanded(child: Consumer<ProductosProvider>(builder: (context, provider, child){
                  ...
                  final  indice = provider.productos[index];
                    return  Padding(
                      ...
                      child: GestureDetector(
                         onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>  SeguimientoPedidoScreen(guia: indice.nroGuia,)));
                         }, 
                        child: Card(
