...
class RegistroSalida1 extends StatefulWidget {
  const RegistroSalida1({
    super.key,
  ...
  @override
  State<RegistroSalida1> createState() => _RegistroSalidaState();
}

final TextEditingController _lugarEntrega = TextEditingController();

class _RegistroSalidaState extends State<RegistroSalida1> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Text(
                            'Latitud: ${locationProv?.latitude.toString()} y este la longitud: ${locationProv?.longitude.toString()}',
                            style: const TextStyle(
                                fontSize: 18, fontWeight: FontWeight.bold),
                            textAlign: TextAlign.center),
                      ),
      ...
      floatingActionButton: SizedBox(
        ...
        child: ElevatedButton(
          onPressed: () async {
            ...
            try {
              // Llamar al método del provider para registrar la salida
              ...
              // Mostrar un diálogo de éxito si la operación fue exitosa
              showDialog(
              ...
              // Mostrar un diálogo de error si ocurre una excepción
              showDialog(
                // ignore: use_build_context_synchronously
                context: context,
                builder: (BuildContext context) {
                  return AlertDialog(
                    backgroundColor: const Color.fromRGBO(64, 64, 64, 1),
                    content: const Text(
                      'El Numero de guia ya esta registrado',
                      style: TextStyle(color: Colors.white, fontSize: 18),
                    ),
                    actions: [
                      TextButton(
